...
(defn load-accounts
  ...
  ([data-dir]
   (load-accounts data-dir "account_settings.json"))
  ([data-dir filename]
...
(defn load-allocator
  ...
  ([data-dir]
   (load-allocator data-dir "allocator_settings.json"))
  ([data-dir filename]
   (let [file-path (str data-dir "/" filename)]
     (read-json-file file-path))))

(defn load-portfolios
  ...
  ([data-dir]
   (load-portfolios data-dir "portfolio_settings.json"))
  ([data-dir filename]
   (let [file-path (str data-dir "/" filename)]
     (read-json-file file-path))))
